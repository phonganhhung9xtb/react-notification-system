...
var NotificationItem = createReactClass({
  ...
  render: function () {
    ...
    if (notification.dismissible === 'both' || notification.dismissible === 'button' || notification.dismissible === true) {
      dismiss = <div className="notification-dismiss" onClick={ this._dismiss }><img src={ 'close_icon.svg' } /></div>;
    ...
    if (notification.timeShow) {
      timeShow = <div className="notification-time" >{notification.timeShow}</div>;
    }
