	    ...
	    function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'div',
	            { className: 'closeAllNotiIcon' },
	            React.createElement('img', { src: 'close_icon.svg' })
	          )
	        ),
	        notifications
	      );
	    ...
	    function render() {
	      ...
	      if (notification.dismissible === 'both' || notification.dismissible === 'button' || notification.dismissible === true) {
	        dismiss = React.createElement(
	          'div',
	          { className: 'notification-dismiss', onClick: this._dismiss },
	          React.createElement('img', { src: 'close_icon.svg' })
	        );
	      ...
	      if (notification.timeShow) {
	        timeShow = React.createElement(
	          'div',
	          { className: 'notification-time' },
	          notification.timeShow
	        );
	      }
	...
	var STYLES = {
	  ...
	  NotificationItem: {
	    ...
	    info: {
	      ...
	      color: '#c5cbce',
	      WebkitBoxShadow: '0 2px 4px 0 rgba(0, 0, 0, 0.5)',
	      MozBoxShadow: '0 2px 4px 0 rgba(0, 0, 0, 0.5)',
