...
var NotificationItem = createReactClass({
  ...
  render: function () {
    ...
    if (notification.dismissible === 'both' || notification.dismissible === 'button' || notification.dismissible === true) {
      dismiss = React.createElement("div", {className: "notification-dismiss", onClick:  this._dismiss}, React.createElement("img", {src:  'close_icon.svg' }));
    ...
    if (notification.timeShow) {
      timeShow = React.createElement("div", {className: "notification-time"}, notification.timeShow);
    }
    ...
    return (
      React.createElement("div", {className:  className, onClick:  this._handleNotificationClick, onMouseEnter:  this._handleMouseEnter, onMouseLeave:  this._handleMouseLeave, style:  notificationStyle }, 
        React.createElement("div", {className:  'titleWapper' }, 
          title, 
          timeShow
        ), 
        message, 
